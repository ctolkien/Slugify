...
namespace Slugify
{
    public class SlugHelperLegacy : ISlugHelper
    {
        protected Config _config { get; set; }

        public SlugHelperLegacy() : this(new Config()) { }

        public SlugHelperLegacy(Config config)
        {
        ...
        /// <summary>
        /// Used to configure the a <see cref="SlugHelperLegacy"/> instance
        /// </summary>
        public class Config
        {
